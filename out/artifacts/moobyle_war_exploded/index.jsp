...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.close').click(function() {
		    $('#msgdivtag').animate({height: 0, opacity: 0}, function() {
		        $(this).remove();
		    });
		});
		});
...
<body id="top">
	...
	<div id="msgdivtag"></div>

	<script type="text/javascript">
	var msg ='<%=session.getAttribute("msg")%>';
		if (msg != "null") {
			document.getElementById('msgdivtag').innerHTML = "<br><div class='alert alert-info alert-dismissable text-center' role='alert'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>"
					+ msg + "</strong></div>";
	...
	<div class="header" id="home1">
		<div class="container">
			<div class="w3l_login">
				<%
					UserAccessDAO userAccessInfo = (UserAccessDAO) session.getAttribute("userAccessInfo");
				...
				<%
						...
						out.print("<a href='profile'><span class='glyphicon glyphicon-user' aria-hidden='true'></span></a>");
						out.print("<a href='logout'><span class='glyphicon glyphicon-log-out' aria-hidden='true'></span></a>");
						//out.print("Hello "+userAccessInfo.getName()+"!");
					}
				%>
			</div>
			<div class="w3l_logo">
				<h1>
					<a href="home">Moobyle<span>Your Reliable Online
							Solution.</span></a>
				</h1>
			</div>
			<div class="search">
	...
	<div class="banner">
		<div class="container">
			<h3>
				Mobile Store, <span>Special Offers</span>
			</h3>
		</div>
	</div>
	<!-- //banner -->
		...
		<div class="container">
			<div class="col-md-5 wthree_banner_bottom_left">
				...
				<div id="small-dialog" class="mfp-hide">
					<iframe src="https://www.youtube.com/embed/D8Ert5yjMV4"></iframe>
				</div>
				<script>
					$(document).ready(function() {
				...
				<div class="bs-example bs-example-tabs" role="tabpanel"
					...
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#home"
							id="home-tab" role="tab" data-toggle="tab" aria-controls="home">Android</a></li>
						<li role="presentation"><a href="#audio" role="tab"
							id="audio-tab" data-toggle="tab" aria-controls="audio">IOS</a></li>
						<li role="presentation"><a href="#video" role="tab"
							id="video-tab" data-toggle="tab" aria-controls="video">Blackberry</a></li>
						<li role="presentation"><a href="#tv" role="tab" id="tv-tab"
							data-toggle="tab" aria-controls="tv">Tablet</a></li>
						<li role="presentation"><a href="#kitchen" role="tab"
							id="kitchen-tab" data-toggle="tab" aria-controls="kitchen">Classic</a></li>
					</ul>
					<div id="myTabContent" class="tab-content">
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="images/3.jpg" alt=" " class="img-responsive" /> <img
									...
									<h5>
										<a href="single.jsp">Mobile Phone1</a>
									</h5>
									<div class="simpleCart_shelfItem">
										...
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												...
												name="w3ls_item" value="Mobile Phone1" /> <input
												type="hidden" name="amount" value="350.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
											<br>
											<a class="hvr-outline-out" href="single.html">Add to
												compare</a>
										</form>
									</div>
								</div>
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="images/4.jpg" alt=" " class="img-responsive" /> <img
											src="images/5.jpg" alt=" " class="img-responsive" /> <img
											src="images/6.jpg" alt=" " class="img-responsive" /> <img
											src="images/7.jpg" alt=" " class="img-responsive" /> <img
											src="images/3.jpg" alt=" " class="img-responsive" /> <img
									...
									<h5>
										<a href="single.jsp">Mobile Phone2</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$330</span> <i class="item_price">$302</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Mobile Phone2" /> <input
												type="hidden" name="amount" value="302.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
											<br>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">Mobile Phone3</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
										...
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Mobile Phone3" /> <input
												type="hidden" name="amount" value="245.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
											<br>
						...
						<div role="tabpanel" class="tab-pane fade" id="audio"
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="images/8.jpg" alt=" " class="img-responsive" /> <img
											src="images/9.jpg" alt=" " class="img-responsive" /> <img
											src="images/10.jpg" alt=" " class="img-responsive" /> <img
											src="images/8.jpg" alt=" " class="img-responsive" /> <img
											src="images/9.jpg" alt=" " class="img-responsive" /> <img
											src="images/10.jpg" alt=" " class="img-responsive" /> <img
											src="images/8.jpg" alt=" " class="img-responsive" /> <img
									...
									<div class="simpleCart_shelfItem">
										...
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Speakers" /> <input type="hidden"
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="images/9.jpg" alt=" " class="img-responsive" /> <img
											src="images/8.jpg" alt=" " class="img-responsive" /> <img
											src="images/10.jpg" alt=" " class="img-responsive" /> <img
											src="images/8.jpg" alt=" " class="img-responsive" /> <img
											src="images/9.jpg" alt=" " class="img-responsive" /> <img
									...
									<h5>
										<a href="single.jsp">Headphones</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
										...
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Headphones" /> <input type="hidden"
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="images/10.jpg" alt=" " class="img-responsive" /> <img
											src="images/8.jpg" alt=" " class="img-responsive" /> <img
											src="images/9.jpg" alt=" " class="img-responsive" /> <img
											src="images/8.jpg" alt=" " class="img-responsive" /> <img
											src="images/9.jpg" alt=" " class="img-responsive" /> <img
									...
									<h5>
										<a href="single.jsp">Audio Player</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$220</span> <i class="item_price">$180</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Audio Player" /> <input
						...
						<div role="tabpanel" class="tab-pane fade" id="video"
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="images/11.jpg" alt=" " class="img-responsive" /> <img
									...
									<div class="simpleCart_shelfItem">
										...
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Laptop" /> <input type="hidden"
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">Notebook</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$290</span> <i class="item_price">$280</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Notebook" /> <input type="hidden"
												name="amount" value="280.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
											<br>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">Kid's Toy</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$120</span> <i class="item_price">$80</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Kid's Toy" /> <input type="hidden"
						...
						<div role="tabpanel" class="tab-pane fade" id="tv"
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">Refrigerator</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">LED Tv</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$700</span> <i class="item_price">$680</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="LED Tv" /> <input type="hidden"
												name="amount" value="680.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
											<br>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">Washing Machine</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$520</span> <i class="item_price">$510</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Washing Machine" /> <input
												type="hidden" name="amount" value="510.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
											<br>
						...
						<div role="tabpanel" class="tab-pane fade" id="kitchen"
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										...
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Grinder" /> <input type="hidden"
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">Water Purifier</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$390</span> <i class="item_price">$350</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Water Purifier" /> <input
												type="hidden" name="amount" value="350.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5>
										<a href="single.jsp">Coffee Maker</a>
									</h5>
									<div class="simpleCart_shelfItem">
										<p>
											<span>$250</span> <i class="item_price">$220</i>
										</p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" /> <input
												type="hidden" name="add" value="1" /> <input type="hidden"
												name="w3ls_item" value="Coffee Maker" /> <input
												type="hidden" name="amount" value="220.00" />
											<button type="submit" class="hvr-outline-out">Add to
												cart</button>
											<br>
											<br>
					...
					<div class="col-md-7 modal_body_right">
						...
						<div class="modal_body_right_cart simpleCart_shelfItem">
							...
							<form action="#" method="post">
								...
								<br>
								<br>
								<a class="hvr-outline-out" href="single.html">Add to compare</a>
							</form>
						</div>
						<h5>Color</h5>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="col-md-7 modal_body_right">
						<h4>Kitchen And Dining Accessories</h4>
						<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco
							laboris nisi ut aliquip ex ea commodo consequat.Duis aute irure
							dolor in reprehenderit in voluptate velit esse cillum dolore eu
							fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
			...
			<div class="agileinfo_new_products_grids">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5>
							<a href="single.jsp">Black Phone</a>
						</h5>
						<div class="simpleCart_shelfItem">
							<p>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5>
							<a href="single.jsp">Induction Stove</a>
						</h5>
						<div class="simpleCart_shelfItem">
							<p>
								<span>$280</span> <i class="item_price">$250</i>
	...
	<div class="newsletter">
		<div class="container">
			<div class="col-md-6 w3agile_newsletter_left">
				<h3>Newsletter</h3>
				<p>Subscibe us to stay updated on our new product, promotion and
					offers.</p>
			</div>
			<div class="col-md-6 w3agile_newsletter_right">
				<form action="subscription?action=subscribe" method="post">
	...
	<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-3 w3_footer_grid">
					<h3>Contact</h3>
					<p>Feel free to contact us. Ask anything you need to know!</p>
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker"
							aria-hidden="true"></i>House # 80, Road # 8/A<span>Mirza
								Golam Hafiz Road</span><span>Dhanmondi, Dhaka-1209</span><span>Bangladesh.
						</span></li>
						<li><i class="glyphicon glyphicon-envelope"
							aria-hidden="true"></i><a href="mailto:alifchoyon@gmail.com">alifchoyon@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone"
							aria-hidden="true"></i><a href="tel:+88 01737 509263">+88
								01737 509263</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
		...
		<button class="w3view-cart goTop" onclick="ScrollTo('top');">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>
					&copy; 2017 Moobyle. All rights reserved | Design by <a
	...
	<%
		new UserAccessModel().addVisitingLog(request.getRemoteAddr());
